  ...
  return (
    <div className={styles.container}>
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/images/about/me.jpg')`,
        }}
      />
    </div>
  );
